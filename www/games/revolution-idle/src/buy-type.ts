...
export class BuyType implements Drawable {
    ...
    constructor(private readonly x: number, private readonly y: number) {
        ...
        this.zoomText = new Text('', new Color(255, 255, 255), 1, false, 'center', 'bottom', x + BuyType.btnSize * 3 / 2 + BuyType.btnPad, y - Text.fontSize);
    }
    /**
    ...
    public draw(graphics: CanvasRenderingContext2D): void {
        ...
        this.zoomText.value = `Buy x${this.quantity}`;
